...
class MinibatchSampler(minibatchIt: Iterator[(Array[NDArray], Array[Int])], totalNumBatches: Int, numSampledBatches: Int) {
  ...
  var currMinibatchImages = None: Option[Array[NDArray]]
  ...
  def nextImageMinibatch(): Array[NDArray] = {
